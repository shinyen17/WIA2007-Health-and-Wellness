...
public class FAQAdapter extends RecyclerView.Adapter<FAQAdapter.FAQViewHolder> {
    ...
    private final List<FAQsFragment.FAQItem> faqList; // Original list
    private List<FAQsFragment.FAQItem> filteredList; // Filtered list
    private String searchQuery = ""; // To store the current search query
    private TextView noResultsTextView;

    // Constructor to initialize the list of FAQ items
    public FAQAdapter(List<FAQsFragment.FAQItem> faqList, TextView noResultsTextView) {
        this.faqList = faqList;
        this.filteredList = new ArrayList<>(faqList);
    ...
    public void onBindViewHolder(@NonNull FAQViewHolder holder, int position) {
        ...
        FAQsFragment.FAQItem item = filteredList.get(position);
    ...
    public void filter(String query) {
        ...
        if (query.isEmpty()) {
            ...
            for (FAQsFragment.FAQItem item : faqList) {
