...
//    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // Set click listeners to navigate to Activity3
        appointmentButton1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Start Activity3 and pass the doctor details
                Intent intent = new Intent(getActivity(), chooseSlot.class);
        ...
        appointmentButton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Start Activity3 and pass the doctor details
                Intent intent = new Intent(getActivity(), chooseSlot.class);
                intent.putExtra("doctor_name", "Dr. Laura");
                intent.putExtra("specialization", "Clinical Therapist");
                intent.putExtra("doctor_image", R.drawable.dr2);
                startActivity(intent);
            }
        });
