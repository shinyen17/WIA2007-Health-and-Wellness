...
public class AppointmentAdapter extends RecyclerView.Adapter<AppointmentAdapter.ViewHolder> {
    ...
    //Constructor
    public AppointmentAdapter(Context context, List<Appointment> appointmentList, boolean isPastFragment) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if(isPastFragment){
            ...
            holder.deleteAppointment.setOnClickListener(v-> {
                ...
                showDialog(v,"Are you sure to delete appointment? " + appointment.getId() , appointment.getId());
            });
        }
        ...
        builder.setMessage(message)
                ...
                .setPositiveButton("CONFIRM", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        // Close all activities and return to the MainActivity
                        Intent intent = new Intent(view.getContext(), MainActivity2.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);  // Clear the activity stack
                        view.getContext().startActivity(intent);

                        // Optionally, call finishAffinity to ensure the current activity and all parent activities are closed
