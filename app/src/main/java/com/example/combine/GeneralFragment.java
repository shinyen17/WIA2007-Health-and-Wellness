...
//    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        appointmentButton5.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        appointmentButton6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Start Activity3 and pass the doctor details
                Intent intent = new Intent(getActivity(), chooseSlot.class);
                intent.putExtra("doctor_name", "Dr. Rebeca");
                intent.putExtra("specialization", "Family Doctor");
                intent.putExtra("doctor_image", R.drawable.dr6);
                startActivity(intent);
            }
        });
