...
//    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        appointmentButton3.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        appointmentButton4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Start Activity3 and pass the doctor details
                Intent intent = new Intent(getActivity(), chooseSlot.class);
                intent.putExtra("doctor_name", "Dr. Susan");
                intent.putExtra("specialization", "Nutritionist");
                intent.putExtra("doctor_image", R.drawable.dr4);
                startActivity(intent);
            }
        });
